...
// import htmlModules from './config/htmlModules' // 自定义插入的html
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "苍晓 blog",
      description: 'Java后端开发技术博客,专注Java后端学习与总结。Java、MySQL、Redis、MQ、Linux等技术文章。',
    }
  },
  ...
  themeConfig: {
    ...
    repo: 'cangxiaocoder/docs', // 导航栏右侧生成Github链接
      ...
      '/Linux/': [
        {
          ...
          collapsable: false, // 不折叠
          children: [
            { title: "Linux基础", path: "/Linux/Linux基础操作" },
          ],
        },
      ],
      '/MySQL/': [
        {
          ...
          collapsable: false, // 不折叠
          children: [
            { title: "MySQL基础", path: "/MySQL/MySQL" },
            { title: "MySQL事务", path: "/MySQL/MySQL_transaction" },
            {
              title: "MySQL行锁",
              path: "/MySQL/MySQL_Lock"
            },
          ],
        },
      ],
      '/Redis/': [
        {
          ...
          children: [
            ...
            { title: "Redis分布式锁", path: "/Redis/Redis分布式锁" },
            {
              title: "缓存一致性",
              path: "/Redis/Redis缓存"
            },
    ...
    author: {
      name: 'cangxiao', // 必需
      link: 'https://github.com/cangxiaocoder', // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'cangxiao | <a href="https://github.com/cangxiaocoder/docs/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
  ...
  head: [
    ...
    [
      ...
      {
        name: 'keywords',
        content: '后端博客,个人技术博客,后端,后端开发,后端框架,Java后端,Java面试题,技术文档,学习,面试,Java、MySQL、Redis、MQ、Linux、markdown',
      },
    ],
    ...
    [
      'thirdparty-search',
      {
        thirdparty: [
          ...
          {
            title: '通过百度搜索本站的',
            frontUrl: `https://www.baidu.com/s?wd=site%3Acangxiaocoder.github.io/docs/%20`,
          },
        ],
      }
    ],
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        ...
        options: {
          ...
          owner: 'cangxiao', // GitHub仓库所有者
          admin: ['cangxiao'], // 对仓库有写权限的人
